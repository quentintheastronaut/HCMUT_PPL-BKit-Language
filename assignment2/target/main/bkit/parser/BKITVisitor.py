...
class BKITVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKITParser#array_assign.
    def visitArray_assign(self, ctx:BKITParser.Array_assignContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BKITParser#array1dlit.
    def visitArray1dlit(self, ctx:BKITParser.Array1dlitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKITParser#arrayndlit.
